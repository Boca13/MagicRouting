...
typedef TMilli GatewayC__Timer0__precision_tag;
...
static void GatewayC__Timer0__fired(void );
# 60 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
...
enum Msp430ClockP____nesc_unnamed4298 {
...
# 64 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void GatewayC__Timer0__startPeriodic(uint32_t dt);
# 56 "GatewayC.nc"
uint8_t GatewayC__dummyVar1 = 0;
...
#line 60
typedef struct GatewayC____nesc_unnamed4328 {
  uint8_t cabecera;
  uint16_t source;
...
#line 93
{
  GatewayC__sendArray((char *)&GatewayC__pkt, sizeof GatewayC__pkt);

  if (GatewayC__dummyVar1++ == 0) {
    printf("Tamaño del pkt: %d\n", sizeof GatewayC__pkt);
    }
  else {
#line 98
    if (GatewayC__dummyVar1 == 1) {
      GatewayC__sendArray((char *)&GatewayC__pkt, sizeof GatewayC__pkt);
      }
    else {
#line 101
      GatewayC__sendByte(GatewayC__dummyVar1);
      }
    }
}
...
# 64 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void GatewayC__Timer0__startPeriodic(uint32_t dt){
#line 64
...
#line 89
{
  GatewayC__Timer0__startPeriodic(5000);
}
